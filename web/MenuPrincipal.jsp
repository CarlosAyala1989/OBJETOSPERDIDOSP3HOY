...
<html>
    ...
    <body>
            ...
            <div id="reclamacion" class="section">
                ...
                <form action="registrarReclamacion" method="POST">
                    ...
                    <div class="form-group canvas-container">
                        ...
                        <button type="button" id="reiniciarBtn" onclick="reiniciarFirma()">Reiniciar Firma</button>
                    </div>
        ...
        <script>
            ...
            // Función para reiniciar la firma digital (limpiar el canvas)
            function reiniciarFirma() {
                ctx.clearRect(0, 0, canvas.width, canvas.height);
                document.getElementById('firmaData').value = ''; // Limpiar el valor del campo oculto
            }
        </script>
    </body>
</html>
